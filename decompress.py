...
if __name__ == "__main__":
    ...
    """
    python path_to_script/decompress.py \
  --data_path path_to_folder_containing_data_but_not_the_data/ \
  --read_split immediate_name_of_the_folder_containing_the_data/ \
  --decompress \
  --delete_zip 
    """
